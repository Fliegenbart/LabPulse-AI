...
fig.update_layout(
    template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)",
    ...
    hovermode="x unified", hoverlabel=dict(bgcolor="#242436", bordercolor="rgba(212,149,106,0.1)", font_size=12, font_family="Bricolage Grotesque"),
...
with tab_forecast:
    ...
    with col_l:
        ...
        if remaining:
            ...
            fig_burn.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)", height=300, margin=dict(l=0, r=0, t=10, b=0), legend=dict(orientation="h", y=1.1, x=0.5, xanchor="center", font=dict(size=9, color="#524e48"), bgcolor="rgba(0,0,0,0)"), hovermode="x unified")
...
with tab_data:
    ...
    with sc1:
        ...
        if not gw_df.empty:
            ...
            fig_gw.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)", height=260, margin=dict(l=0, r=0, t=5, b=0), showlegend=False, hovermode="x unified")
    ...
    with sc2:
        ...
        if not are_df.empty:
            ...
            fig_are.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)", height=260, margin=dict(l=0, r=0, t=5, b=0), showlegend=False, hovermode="x unified")
    ...
    with st.expander("Google Trends"):
        ...
        if user_terms:
            ...
            if not trends_df.empty:
                ...
                fig_t.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)", height=280, margin=dict(l=0, r=0, t=5, b=0), legend=dict(orientation="h", y=1.1, x=0.5, xanchor="center", font=dict(size=9, color="#524e48"), bgcolor="rgba(0,0,0,0)"), hovermode="x unified")
        ...
        if regional_df.empty:
            ...
            if not map_df.empty:
                ...
                with col_m:
                    ...
                    fig_m.update_layout(template="plotly_dark", height=480, margin=dict(l=10, r=10, t=10, b=10), paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(36,36,54,0.5)",
